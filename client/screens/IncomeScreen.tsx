...
export default function IncomeScreen() {
  ...
  const { incomeEntries, totalIncome, addIncomeEntry, updateIncomeEntry, deleteIncomeEntry } = useApp();
        ...
        <Animated.View entering={FadeInDown.delay(200).duration(300)}>
          ...
          {incomeEntries.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyText}>Noch keine Einnahmen hinzugefügt</Text>
                ...
                >
                  <View style={styles.incomeLeft}>
                    <View style={styles.incomeIconContainer}>
                      <Feather name={getIconForType(entry.type) as any} size={20} color="#10B981" />
                    </View>
                    <View>
