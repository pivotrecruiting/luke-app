...
const expenseTypes = [
  "Versicherungen", "Netflix", "Wohnen", "Handy", "Altersvorsorge",
  "Spotify", "Fitness", "Abos", "Fahrticket", "Auswärts essen"
];

export const Onboarding5 = (): JSX.Element => {
    ...
    <main className="bg-white w-full min-w-[390px] min-h-[844px] relative flex flex-col items-center px-5 py-8">
      ...
      <div className="mt-6 w-full">
        ...
        <p className="mt-3 [font-family:'Inter',Helvetica] font-normal text-gray-400 text-base">
          Miete, Abos oder Verträge – Luke reserviert diesen Betrag automatisch.
        </p>
      </div>
      ...
      <div className="mt-auto w-full mb-8">
        ...
        <Button
          onClick={() => setLocation("/safe-to-spend")}
